/*
  ...
  Version v13.1p_2025-04-15/LGPL Deployment (2025-04-15)
...
if (window.isc && isc.version != "v13.1p_2025-04-15/LGPL Deployment" && !isc.DevUtil) {
    isc.logWarn("SmartClient module version mismatch detected: This application is loading the core module from "
        + "SmartClient version '" + isc.version + "' and additional modules from 'v13.1p_2025-04-15/LGPL Deployment'. Mixing resources from different "
...
isc.DaySchedule.addProperties({
    ...
    draw : function (a, b, c, d) {
        ...
        if (this._refreshEventsOnDraw) {
            ...
            //this._refreshData("draw");
            this.delayedRefreshEvents("draw");
        }
...
isc.MonthSchedule.addProperties({
    ...
    draw : function ( ) {
        ...
        if (this._refreshEventsOnDraw) {
            delete this._refreshEventsOnDraw;
            // run _refreshData() which will either fetch or call refreshEvents()
            this.delayCall("_refreshData", null, 100);
        }
        if (this._fireViewChangedOnDraw) {
            delete this._fireViewChangedOnDraw;
            this.calendar.currentViewChanged(this.viewName);
...
// when this is true, labelColumnWidth acts as a minimum
...
draw : function (a, b, c, d) {
    ...
    if (this._fetchAfterDraw) {
        delete this._fetchAfterDraw;
        this.fetchData();
    }
